...
public class MainActivity extends BaseActivity implements ProductView, Toolbar.OnMenuItemClickListener, SyncView, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPager.setPageTransformer(true, new ZoomOutPageTransformer());//滑动效果
...
//    }
    ...
    private void initTitle() {
        ...
        try {
            CalligraphyTypefaceSpan typefaceSpan = new CalligraphyTypefaceSpan(TypefaceUtils.load(getAssets(), "fonts/Hero.otf"));
...
//        }
    ...
    public void onClick(View v) {
        if (mPager.getCurrentItem() == 2){
            Log.d("lyl","second add button");
            ContactAddActivity.actionStart(MainActivity.this);
        } else{
            Log.d("lyl","first add button");
