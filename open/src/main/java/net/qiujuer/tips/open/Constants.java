...
public class Constants {
    ...
    public static final String QQ_APP_ID = "afs";

    public static final String WX_APP_ID = "adfs";
    ...
    public static final String APP_NAME = "Hello Notes";

    public static final String WB_APP_ID = "asfd";
